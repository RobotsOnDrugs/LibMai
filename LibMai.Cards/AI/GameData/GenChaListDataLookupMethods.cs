namespace LibMai.Cards.AI.GameData;

public static class GenChaListDataLookupMethods
{
	// This is a quick-and-dirtyish program to deserialize extracted data to ChaListData objects and generate C Sharp static methods for LibMai.Cards.AI.Chara.Friendly.AiFriendlyNameLookup
	...
	internal static void GenerateChaListDataFriendlyNames()
	{
		...
		outputFile.WriteLine("namespace LibMai.Cards.AI.Chara.Friendly;");
